...
🎬 Contexte
Ciné Délices est une plateforme web développée pour le compte d'une entreprise fictive du secteur du divertissement (streaming et production audiovisuelle). L'entreprise souhaite enrichir l'expérience de ses utilisateurs en proposant un prolongement original à la consommation de films, de séries et d'animé : une plateforme de recettes de cuisine inspirées des œuvres cinématographiques.
